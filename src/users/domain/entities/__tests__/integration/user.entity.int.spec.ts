...
describe('User entity integration tests', () => {
  describe('Constructor method', () => {
    it('Should throw an error when creating a user whit invalid name', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        name: null,
      }
    ...
    it('Should throw an error when creating a user whit invalid email', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        email: null,
      }
    ...
    it('Should throw an error when creating a user whit invalid password', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
        password: null,
      }
    ...
    it('Should throw an error when creating a user whit invalid createdAt', () => {
      let props: UserProps = {
        ...UserDataBuilder({}),
  ...
  describe('update method', () => {
    it('Should throw an error when update a user whit invalid name', () => {
